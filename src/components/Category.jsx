...
const Category = ({result}) => {
  ...
  return (
    ...
    <div className="w-full md:w-48 sm:w-48  mr-4 mt-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow overflow-hidden transform transition duration-500 hover:scale-110">
        ...
        {/* <div className=" px-5 pb-5 flex justify-items-end bg-gray-300 hover:bg-main h-16">
            <a href="#">
